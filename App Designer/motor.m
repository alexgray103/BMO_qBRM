...
classdef motor < handle 
    ...
    properties (Constant, Hidden)
       ...
       DCSERVODLL='Thorlabs.MotionControl.Benchtop.BrushlessMotorCLI.dll';  
       DCSERVOCLASSNAME='Thorlabs.MotionControl.Benchtop.BrushlessMotorCLI.BenchtopBrushlessMotor';            
    ...
    methods
        ...
        function connect(h,serialNo)  % Connect device
            ...
            if ~h.isconnected
                switch(serialNo(1:2))
                    case '73'   % Serial number corresponds to a MLS203-1
                ...
                try
                    ...
                    MotDir=Thorlabs.MotionControl.GenericMotorCLI.MotorDirection.Forward; % MotDir is enumeration for 'forwards'
